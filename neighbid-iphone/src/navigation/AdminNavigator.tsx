...
import {LayoutDashboard, Users, BarChart2, User, Sparkles, Layers} from 'lucide-react-native';
...
export default function AdminNavigator({onLogout}: Props) {
  return (
    <Tab.Navigator
      screenOptions={{
        headerShown: false,
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, size, focused}) => (
            <TabIcon label="Residents" focused={focused}>
              <Users color={color} size={size - 2} strokeWidth={2} />
            </TabIcon>
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, size, focused}) => (
            <TabIcon label="Hub" focused={focused}>
        ...
        options={{
          tabBarIcon: ({color, size, focused}) => (
            <TabIcon label="Reports" focused={focused}>
              <BarChart2 color={color} size={size - 2} strokeWidth={2} />
            </TabIcon>
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, size, focused}) => (
            <TabIcon label="AI Tools" focused={focused}>
